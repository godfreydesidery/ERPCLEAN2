...
class TenantProvisioningServiceTest {
    ...
    void setUp() {
        service = new TenantProvisioningService(organisations, companies, branches, users,
                userBranches, passwordEncoder, companyProvisioning, stockLocationSeeder,
                pettyCashFundSeeder, priceListProvisioner, walkInCustomerProvisioner,
                posTillProvisioner, roles, userRoles);
    ...
    void bootstrapShapedRequestCreatesNothingOptional() {
        TenantProvisioningService withRealProvisioners = new TenantProvisioningService(
                organisations, companies, branches, users, userBranches, passwordEncoder,
                companyProvisioning, stockLocationSeeder, pettyCashFundSeeder,
