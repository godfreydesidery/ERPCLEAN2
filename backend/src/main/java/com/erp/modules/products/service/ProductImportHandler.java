...
public class ProductImportHandler implements BulkImportHandler {
    ...
    public List<ColumnSpec> columns(Long companyId) {
        ...
        return List.of(
                ...
                baseUnit,
                ColumnSpec.of(COL_COST_AMOUNT, false, "Unit cost. Requires a currency when set."),
                ...
                ColumnSpec.of(COL_REORDER_LEVEL, false, "Optional planning field."),
                ColumnSpec.of(COL_REORDER_QTY, false, "Optional planning field."),
                ColumnSpec.of(COL_LEAD_TIME, false, "Optional supply lead time in days."),
