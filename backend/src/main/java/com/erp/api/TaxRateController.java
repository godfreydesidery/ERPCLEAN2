...
public class TaxRateController {
    ...
    @PreAuthorize("@perm.has('TAXRATE.MANAGE')")
    public TaxRateDto create(@Valid @RequestBody CreateTaxRateRequest request) {
        return salesInvoiceService.createTaxRate(request);
    }
