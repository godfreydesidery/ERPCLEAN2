...
import { RfqDto, RfqStatus } from './models/rfq.model';
...
/**
 * RFQ list screen. Company-scoped, paginated.
 * Mirrors purchase-order-list structure.
 */
@Component({
    ...
    this.immediateTrigger$
      .pipe(
        switchMap(({ page }) => {
          ...
          return this.rfqService.listRfqs(companyId, page, DEFAULT_SIZE);
        }),
        takeUntilDestroyed(),
      )
      .subscribe({
