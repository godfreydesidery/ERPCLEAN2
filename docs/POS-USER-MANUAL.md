...
1. [Getting Started](#getting-started)
    ...
    - [First-Run Setup — Pointing the Till at Your Server](#first-run-setup--pointing-the-till-at-your-server)
...
5. [Taking Payment](#taking-payment)
    ...
    - ["Did that go through?" — the safe-retry guarantee](#did-that-go-through--the-safe-retry-guarantee)
...
7. [Troubleshooting and Good Practice](#troubleshooting-and-good-practice)
    ...
    - [Your session has expired / you were signed out](#your-session-has-expired--you-were-signed-out)
    - [You do not have permission](#you-do-not-have-permission)
    - [Age not verified stops a sale](#age-not-verified-stops-a-sale)
    - ["Your user has no sales-agent record"](#your-user-has-no-sales-agent-record)
    - [A scan or search finds nothing](#a-scan-or-search-finds-nothing)
    - [The scanner is a "keyboard wedge" — keep the field focused](#the-scanner-is-a-keyboard-wedge--keep-the-field-focused)
    - [Slow network or a "blip" mid-sale — the unknown-outcome case](#slow-network-or-a-blip-mid-sale--the-unknown-outcome-case)
    - ["Tendered is less than the total"](#tendered-is-less-than-the-total)
    - [Reprinting a receipt (and why it never makes a new sale)](#reprinting-a-receipt-and-why-it-never-makes-a-new-sale)
    - [The printer, cash drawer, and scale in this build](#the-printer-cash-drawer-and-scale-in-this-build)
    - [Good habits that prevent problems](#good-habits-that-prevent-problems)
    - [Quick reference — message to action](#quick-reference--message-to-action)
8. [For Supervisors and Store Managers](#for-supervisors-and-store-managers)
    ...
    - [Reconcile / Z-read — reading and posting the variance](#reconcile--z-read--reading-and-posting-the-variance)
